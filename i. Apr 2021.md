...
LT.Results, IIf([Test Date]>43951 And [Test Date]<44317,1,0) AS Sample, 
IIf([Sample]=1 And [Results]>0,1,0) AS Result, IIf([Gender]="Female" And [CURR_APR]=1 And [Age]>=15 And [Age] <=49,1,0) 
...
##### 20: SDI FOR THE REPORTING PERIOD (MONTH)
```sql
